...
<head>
    ...
    <title>TE Admin Page</title>

    <!-- Bootstrap Core CSS -->
    <link href="<c:url value="/public/lib/bootstrap/css/bootstrap.min.css" />" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="<c:url value="/public/lib/bootstrap/css/sb-admin.css" />" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="<c:url value="/public/lib/bootstrap/css/stylish-portfolio.css" />" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="<c:url value="/public/lib/bootstrap/css/plugins/morris.css" />" rel="stylesheet">
    
     <link href="<c:url value="/public/lib/bootstrap/css/dynamic.css" />" rel="stylesheet">
...
<%-- 	 <link href="<c:url value="/public/css/dynamic.css" />" rel="stylesheet"> --%>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<c:url value="/admin"/>">TE Admin</a>
            </div>
            <!-- Top Menu Items -->
